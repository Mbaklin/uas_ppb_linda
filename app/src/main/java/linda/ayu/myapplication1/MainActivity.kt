...
import linda.ayu.myapplication1.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.add(
            ImageData(
                "https://cf.shopee.co.id/file/d68617b7e62506bf27065037a0c409db"
            )
        )
        list.add(
            ImageData(
                "https://cf.shopee.co.id/file/1662e2f55b5ad2bc8a4a2f3fe0f34493"
            )
        )
        list.add(
            ImageData(
                "https://img-global.cpcdn.com/recipes/fbe8b331c0588189/680x482cq70/oatmeal-granola-bar-fitbar-homemade-foto-resep-utama.jpg"
            )
        )
